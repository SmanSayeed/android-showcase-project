  ...
  return (
    <div className="min-h-screen bg-background pt-12 pb-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {(() => {
          let validImage = project.image_url
          if (!validImage && project.image) validImage = project.image
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start mb-16">
              ...
              <div className="space-y-8">
                ...
                {project.full_description && (
                  <div className="prose prose-invert max-w-none bg-card p-6 rounded-xl border border-border" dangerouslySetInnerHTML={{ __html: project.full_description }} />
                )}
              </div>
            </div>
          )
